...
class UpdateFacultyDebtDTO
{
     ...
     * @var FacultyDebt
     */
    private FacultyDebt $faculty_debt;

    /**
     * @param array $data
     * @return UpdateFacultyDebtDTO
     */
    public static function fromArray(array $data): UpdateFacultyDebtDTO
    {
        $dto = new self();
        ...
        $dto->setFacultyDebt($data['faculty_debt']);
        return $dto;
    }
     ...
     * @return FacultyDebt
     */
    public function getFacultyDebt(): FacultyDebt
    {
        return $this->faculty_debt;
    }

    /**
     * @param FacultyDebt $faculty_debt
     */
    public function setFacultyDebt(FacultyDebt $faculty_debt): void
    {
        $this->faculty_debt = $faculty_debt;
    }
}
