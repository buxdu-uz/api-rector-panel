...
class StoreFacultyDebtAction
{
    /**
     * @param StoreFacultyDebtDTO $dto
     * @return FacultyDebt
     * @throws Exception
     */
    public function execute(StoreFacultyDebtDTO $dto): FacultyDebt
    {
        DB::beginTransaction();
        try {
            $facultyDebt = new FacultyDebt();
            $facultyDebt->user_id = Auth::id();
